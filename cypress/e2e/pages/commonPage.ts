 ...
 */
  ...
  public acceptButton:string ="#html-body > footer > div > div > div.footer-btm._accept_cookies.footer-btm-div > div > button"
/**
 ...
 */ 
  ...
  loginMTNApplicationWithiInvalidEmail(){
    this.invalidEmailAauthentication()
  }
 ...
 * Authentication via Email */
   ...
   emailAauthentication(){
    cy.get("#c-ttl").then(($input)=>{
      const val = $input.text()
      if( val == "We value your privacy")
      {
           cy.get("#c-p-bn").click()
      }
      })
