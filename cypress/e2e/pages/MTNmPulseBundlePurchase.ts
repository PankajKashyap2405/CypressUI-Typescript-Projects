...
public bundlexplore:string="#block-selfservice-content > div > section.everything-slider-wrap > div > div > div > div.owl-carousel.everything-slide.owl-loaded.owl-drag > div.owl-stage-outer > div > div:nth-child(3) > div > div > div > a > button > i"
