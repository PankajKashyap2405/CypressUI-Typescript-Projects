...
public routerPage:string = "#maincontent > div.columns.mf-initial > div > div.content-wrapper.mf-initial > div > div > div > div > div.col-md-8.mf-initial > div > div.page-title-wrapper.product.mf-initial > h1 > span"
public addtoCartButton:string = "div[class='actions user-buy-action-wrap'] button[id='product-addtocart-button']"
public buyNow:string = "#buy-now"
...
public clickOnConfirm:string="button[class='button action continue primary btn btn-mtn-primary-ye'] span span"
public clickOnContinue:string = "#collapseThree > div.checkout-billing-address > div.mtn-stack-h.form-bottom-control > div > button"
...
public continueCntcinfo:string="div[class='mtn-stack-h form-bottom-control'] div[class='mtn-btn-group']"
 ...
 */
 ...
 //validate error message when user enters invalid email
...
clickOnDeviceButton(){
 ...
 validateDifferentProductsButtonsOnHomePage(){
  ...
  validate5gRouterPage() {
    expect(Basepage.elementVisibleContainsText(this.routerPage,testdata.HomePage.Account.productName))
  }
 ...
 clickOnConfirmButton(){
  cy.wait(3000)
   Basepage.clickElement(this.clickOnConfirm)
 }
